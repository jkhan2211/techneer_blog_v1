  ...
  <nav className="relative flex items-center justify-between py-4 border-b border-zinc-800">
    ...
    <div className="w-3/6 lg:w-2/6 brandName">
      <Link to="/" className="flex items-center group">
        <img src="./FinalLogo.png" alt="Logo" className="h-24 md:h-28 lg:h-32 hover:scale-110 hover:rotate-2 transition-all duration-500 drop-shadow-lg group-hover:drop-shadow-xl" />
      </Link>
    </div>
